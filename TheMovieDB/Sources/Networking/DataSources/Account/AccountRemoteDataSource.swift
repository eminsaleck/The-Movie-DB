...
final class AccountRemoteDataSource: AccountRemoteDataSourceProtocol {
    ...
    func getFavoriteList(page: Int?, completion: @escaping (Result<[Domain.Movie], Error>) -> Void) {
    ...
    func getWatchlist(page: Int?, completion: @escaping (Result<[Domain.Movie], Error>) -> Void) {
        guard let account = authManager.userAccount else { return }
    ...
    func getRecommendedList(page: Int?, completion: @escaping (Result<[Domain.Movie], Error>) -> Void) {
    ...
    func getCustomLists(page: Int?, completion: @escaping (Result<[Domain.List], Error>) -> Void) {
        guard let accountId = authManager.accessToken?.accountId,
            let accessToken = authManager.accessToken?.token else {
            return
        }
    ...
    func getCustomListMovies(listId: String, completion: @escaping (Result<[Domain.Movie], Error>) -> Void) {
    ...
    func getAccountDetail(completion: @escaping (Result<Domain.User, Error>) -> Void) {
        guard let account = authManager.userAccount else { return }
