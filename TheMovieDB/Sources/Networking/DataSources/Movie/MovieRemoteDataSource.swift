...
final class MovieRemoteDataSource: MovieRemoteDataSourceProtocol {
    ...
    func getUpcomingMovies(page: Int, completion: @escaping (Result<[Domain.Movie], Error>) -> Void) {
    ...
    func getPopularMovies(page: Int, completion: @escaping (Result<[Domain.Movie], Error>) -> Void) {
    ...
    func getTopRatedMovies(page: Int, completion: @escaping (Result<[Domain.Movie], Error>) -> Void) {
    ...
    func getSimilarMovies(page: Int, movieId: Int, completion: @escaping (Result<[Domain.Movie], Error>) -> Void) {
    ...
    func getMoviesByGenre(page: Int, genreId: Int, completion: @escaping (Result<[Domain.Movie], Error>) -> Void) {
    ...
    func getMovieDetail(with movieId: Int,
                        completion: @escaping (Result<Domain.Movie, Error>) -> Void) {
    ...
    func getMovieReviews(for movieId: Int, page: Int?, completion: @escaping (Result<[Domain.Review], Error>) -> Void) {
    ...
    func getMovieVideos(for movieId: Int, page: Int?, completion: @escaping (Result<[Domain.Video], Error>) -> Void) {
    ...
    func getMovieAccountState(for movieId: Int,
                              completion: @escaping (Result<Domain.Movie.AccountState, Error>) -> Void) {
