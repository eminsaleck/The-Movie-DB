//
//  ProfileLoginDetailsViewController.swift
//  TabBarApp
//
...
class ProfileLoginDetailsViewController: UIViewController {
    ...
    var viewModel: ProfileLoginDetailsViewModel!
    
    init(viewModel: ProfileLoginDetailsViewModel) {
...
extension ProfileLoginDetailsViewController: UITableViewDataSource, UITableViewDelegate
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.isSecureTextEntry = data.isSecureTextEntry
        return cell
    }
